...
const data = {
    ...
    steps: [
        ...
        {name: "Mince", row: 3, col: 1, time: [213, 228], prev_steps: null, ingredients: [2]},
        {name: "Mince", row: 4, col: 1, time: [218, 228], prev_steps: null, ingredients: [3]},
        {name: "Mix", row: 1, col: 2, time: [140, 174], prev_steps: [1], ingredients: [4, 5]},
        {name: "Put", row: 1, col: 3, time: [289, 316], prev_steps: [2, 5], ingredients: null},
        {name: "Mix", row: 3, col: 3, time: [186, 250], prev_steps: [3, 4], ingredients: [6, 7, 8, 9]},
        {name: "Add", row: 1, col: 4, time: [323, 338], prev_steps: [6, 7], ingredients: [10]},
        {name: "Cook", row: 1, col: 5, time: [342, 348], prev_steps: [8], ingredients: null},
        ...
        {name: "Add", row: 1, col: 6, time: [488, 498], prev_steps: [9, 10, 11, 12], ingredients: null},
        {name: "Simmer", row: 1, col: 7, time: [500, 519], prev_steps: [14], ingredients: null},
